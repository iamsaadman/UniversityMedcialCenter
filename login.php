    ...
    <form action="login_process.php" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <div class="bg-slate-100 rounded-xl p-1 flex gap-1" id="roleToggle">
          ...
          <button type="button" data-role="admin" class="flex-1 px-4 py-2 rounded-lg text-sm font-semibold text-slate-600 hover:text-slate-900 hover:bg-white/80 transition">Admin</button>
        </div>
