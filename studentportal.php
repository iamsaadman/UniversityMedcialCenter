...
<div class="p-6 md:p-8 min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
  ...
  <button class="bg-white/20 hover:bg-white/30 backdrop-blur-sm p-3 rounded-lg transition flex items-center justify-center text-center">
    <div class="text-sm font-semibold">
      🧠 Upcoming Counseling Session January 28, 2026
    </div>
  </button>
</div>
